...
_PAPER_SEARCH_SCRIPTS = os.path.join(os.path.dirname(os.path.dirname(_SCRIPT_DIR)), 'paper-search', 'scripts')
if _PAPER_SEARCH_SCRIPTS not in sys.path:
    sys.path.insert(0, _PAPER_SEARCH_SCRIPTS)
